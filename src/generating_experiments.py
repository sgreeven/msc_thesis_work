...
class EVO(NetLogoModelStructureInterface):
    ...
    uncertainties = [ParameterUncertainty((1.01,1.03), 'ExpFactor'),
                     ...
                     ParameterUncertainty((0,100), 'TimeHorizonGov4'),
                     ParameterUncertainty((0,100), 'TimeHorizonGov5'),
                     ParameterUncertainty((0,100), 'TimeHorizonInd1'),
                     ParameterUncertainty((0,100), 'TimeHorizonInd2'),
                     ParameterUncertainty((0,100), 'TimeHorizonInd3'),
                     ParameterUncertainty((0,100), 'TimeHorizonInd4'),
                     ParameterUncertainty((0,100), 'TimeHorizonInd5'),
                     ...
                     ParameterUncertainty((0,0.20), 'InitialSeverityOfClimateDisaster'),
