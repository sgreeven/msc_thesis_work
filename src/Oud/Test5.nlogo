...
to DetermineEmission
  ask Persons [set Emission max list 0 (1 - CCawareness - ReductionPolicy)]
  ask Governments [set Emission max list 0 (1 - PoliticalPreference - ReductionPolicy) * (#Persons / #Governments / RatioLocalEmissionNationalEmission - #Persons / #Governments)]
end 
