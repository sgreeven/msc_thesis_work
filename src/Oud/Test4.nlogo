...
to setup
  ...
  create-persons #persons[
    ...
    ask persons with [countrycode = 1] [set vision random-normal Vision1 10
    while [(vision > 100) or (vision < 0)]  [set vision random-normal Vision1 10]]
    ask persons with [countrycode = 2] [set vision random-normal Vision2 10
    while [(vision > 100) or (vision < 0)]  [set vision random-normal Vision2 10]]
    ask persons with [countrycode = 3] [set vision random-normal Vision3 10
    while [(vision > 100) or (vision < 0)]  [set vision random-normal Vision3 10]]
    ask persons with [countrycode = 4] [set vision random-normal Vision4 10
    while [(vision > 100) or (vision < 0)]  [set vision random-normal Vision4 10]]
    ask persons with [countrycode = 5] [set vision random-normal Vision5 10
    while [(vision > 100) or (vision < 0)]  [set vision random-normal Vision5 10]]
    ask persons with [countrycode = 6] [set vision random-normal Vision6 10
    while [(vision > 100) or (vision < 0)]  [set vision random-normal Vision6 10]]
    ask persons with [countrycode = 7] [set vision random-normal Vision7 10
    while [(vision > 100) or (vision < 0)]  [set vision random-normal Vision7 10]]
    ask persons with [countrycode = 8] [set vision random-normal Vision8 10
    while [(vision > 100) or (vision < 0)]  [set vision random-normal Vision8 10]]
    ask persons with [countrycode = 9] [set vision random-normal Vision9 10
    while [(vision > 100) or (vision < 0)]  [set vision random-normal Vision9 101]]
    ask persons with [countrycode = 10] [set vision random-normal Vision10 10
    while [(vision > 100) or (vision < 0)]  [set vision random-normal Vision10 10]]   
  ]
...
212
259
Average Vision of Agents on Climate Change Impact [Years]\n
11
0.0
1
...
505
611
Misschien vooraf een curve definiëren die reductiedoelen bepaalt? \n\nbvb 2020 20% reductie, 2050 50% reductie, 2080 80% reductie\n\nOf Moet dit een dynamische curve zijn afhankelijk van de CC Impact(CumGHG) grafiek?\n\n
11
0.0
1
...
1550
770
Idee: governments also assess the impact graph, but they have a more long term vision that citizens themselves. Het nationale mitigatiebeleid ontstaat dan uit een mix van de individuele preference en de eigen assessment (in principe verlaagt dit doordat indiviudals meer korte termijn willen). \nVerschillen kunnen dan misschien ontstaan door het mitigatiepotentieel (individual mitigatie potentieel is hoger in het begin dan national)
11
15.0
1
